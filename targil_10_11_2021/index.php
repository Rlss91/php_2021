...
$arr = ['1', '2', '3', '4'];
sort($arr);
if(isset($_COOKIE['sortQuery'])){
    echo "sortQuery:" . $_COOKIE['sortQuery'] . "<br>";
    $queryArr = explode('&', $_COOKIE['sortQuery']);
    $obj = ['aac'=>0, 'time'=>0];
    echo "queryArr: ";
    print_r($queryArr);
    echo "<br>";
        ...
        <form action="controller.php" method="get">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" name="asd" id="asd" value=<?=5+5?> />
                </div>
            </div>
            <?php
